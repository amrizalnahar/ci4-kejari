                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="margin-left: -10x; margin-right: 0px;">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/img/kantor.jpeg" class="d-block w-100" alt="...">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card" style="margin-top: 15px;">
                            <div class="card-body">
                                <img src="assets/img/slide2.png" class="card-img-top" alt="...">
                                <h5 class="card-title">Special title treatment</h5>
                                <p class="card-text">
                                    With supporting text below as a natural lead-in to additional content.Halaman lain website dalam bentuk card text yang berisikan gambar, judul dan deskripsi singkat dari topik.
                                </p>
                                <a href="#" class="btn btn-primary" style="background-color: green;">Go somewhere</a>
                            </div>
                        </div>
                        <span class="badge" style="background-color: green; margin-top: 20px; margin-bottom: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play" viewBox="0 0 16 16">
                                <path d="M10.804 8 5 4.633v6.734L10.804 8zm.792-.696a.802.802 0 0 1 0 1.392l-6.363 3.692C4.713 12.69 4 12.345 4 11.692V4.308c0-.653.713-.998 1.233-.696l6.363 3.692z" />
                            </svg> Video Kejaksaan Negeri</span>
                        <div class="col">
                        ...
                        <div class="col-lg-8">
                            <span class="badge" style="background-color: green; margin-top: 20px; margin-bottom: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                                </svg> LOKASI KEJAKSAAN NEGERI KABUPATEN PEKALONGAN</span>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.8816226406175!2d109.59024641459341!3d-7.023198494926974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e701fed4b23b741%3A0xeac2d1d9b0e7f64f!2sJl.%20Teuku%20Umar%20No.1%2C%20Tanjungsari%2C%20Kec.%20Kajen%2C%20Pekalongan%2C%20Jawa%20Tengah%2051161!5e0!3m2!1sid!2sid!4v1628732545759!5m2!1sid!2sid" width="800px" height="auto" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <span class="badge" style="background-color: green;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play" viewBox="0 0 16 16">
                        ...
                        <div class="card" style="margin-top: 15px;">
                            <div class="card-body">
                                <img src="assets/img/slide3.png" class="card-img-top" alt="...">
                                <h5 class="card-title">Special title treatment</h5>
                                <p class="card-text">
                                    With supporting text below as a natural lead-in to additional content. Halaman lain website dalam bentuk card text yang berisikan gambar, judul dan deskripsi singkat dari topik
                                </p>
                        ...
                        <div class="sidebar" style="background-color: white;">
                            <div class="Slide1">
                                ...
                                <div class="card" style="margin-top: 15px; margin-bottom: 15px;">
                                    <div class="card-body">
                                        <img src="assets/img/pimpinan.jpg" class="card-img-top" alt="...">
                            ...
                            <div class="card mb-3" style="max-width: 550px; margin-top: 15px;">
                                <div class="row g-1">
                                    <div class="col-md-4" style="margin-top: 15px;">
                                        <img src="assets/img/kantor.jpeg" class="img-fluid rounded-start" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                            ...
                            <div class="foto" style="margin-top: 10px; margin-bottom: 30px;">
                                <img src="assets/img/arif-zaenuri.png" width="410" height="220">
                            </div>
                        </div>
                    </div>
    </section>
