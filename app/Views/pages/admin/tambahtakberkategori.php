...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/takberkategori/save" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_takberkategori')) ? 'is-invalid' : ''; ?>" id="judul_takberkategori" name="judul_takberkategori" autofocus value="<?= old('judul_takberkategori'); ?>" placeholder="Masukkan Judul">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <label class="input-group-text myPreviewgambar" for="gambar_takberkategori">Pilih Gambar</label>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="tag_takberkategori" id="tag_takberkategori" class="form-control" placeholder="Masukkan Tag ..." value="<?= old('tag_takberkategori'); ?>">
                        </div>
