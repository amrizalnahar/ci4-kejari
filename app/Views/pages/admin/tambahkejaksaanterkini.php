...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/kejaksaanterkini/save" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_kejaksaanterkini')) ? 'is-invalid' : ''; ?>" id="judul_kejaksaanterkini" name="judul_kejaksaanterkini" autofocus value="<?= old('judul_kejaksaanterkini'); ?>" placeholder="Masukkan Judul">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <label class="input-group-text myPreviewgambar" for="gambar_kejaksaanterkini">Pilih Gambar</label>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="tag_kejaksaanterkini" id="tag_kejaksaanterkini" class="form-control" placeholder="Masukkan Tag ..." value="<?= old('tag_kejaksaanterkini'); ?>">
                        </div>
