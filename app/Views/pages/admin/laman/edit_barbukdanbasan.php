...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/barbukdanbasan/update/<?= $barbukdanbasan['id_barbukdanbasan']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_barbukdanbasan" value="<?= $barbukdanbasan['slug_barbukdanbasan']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_barbukdanbasan')) ? 'is-invalid' : ''; ?>" id="judul_barbukdanbasan" name="judul_barbukdanbasan" autofocus value="<?= (old('judul_barbukdanbasan')) ? old('judul_barbukdanbasan') : $barbukdanbasan['judul_barbukdanbasan'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_barbukdanbasan')) ? old('isi_barbukdanbasan') : $barbukdanbasan['isi_barbukdanbasan'] ?>
                        </textarea>
