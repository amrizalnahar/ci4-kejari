...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/pidsus/update/<?= $pidsus['id_pidsus']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_pidsus" value="<?= $pidsus['slug_pidsus']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_pidsus')) ? 'is-invalid' : ''; ?>" id="judul_pidsus" name="judul_pidsus" autofocus value="<?= (old('judul_pidsus')) ? old('judul_pidsus') : $pidsus['judul_pidsus'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_pidsus')) ? old('isi_pidsus') : $pidsus['isi_pidsus'] ?>
                        </textarea>
