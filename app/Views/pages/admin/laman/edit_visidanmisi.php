...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/visidanmisi/update/<?= $visidanmisi['id_visidanmisi']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_visidanmisi" value="<?= $visidanmisi['slug_visidanmisi']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_visidanmisi')) ? 'is-invalid' : ''; ?>" id="judul_visidanmisi" name="judul_visidanmisi" autofocus value="<?= (old('judul_visidanmisi')) ? old('judul_visidanmisi') : $visidanmisi['judul_visidanmisi'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_visidanmisi')) ? old('isi_visidanmisi') : $visidanmisi['isi_visidanmisi'] ?>
                        </textarea>
