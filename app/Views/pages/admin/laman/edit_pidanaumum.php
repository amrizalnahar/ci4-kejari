...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/pidanaumum/update/<?= $pidanaumum['id_pidanaumum']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_pidanaumum" value="<?= $pidanaumum['slug_pidanaumum']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_pidanaumum')) ? 'is-invalid' : ''; ?>" id="judul_pidanaumum" name="judul_pidanaumum" autofocus value="<?= (old('judul_pidanaumum')) ? old('judul_pidanaumum') : $pidanaumum['judul_pidanaumum'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_pidanaumum')) ? old('isi_pidanaumum') : $pidanaumum['isi_pidanaumum'] ?>
                        </textarea>
