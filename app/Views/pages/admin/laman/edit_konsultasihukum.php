...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/konsultasihukum/update/<?= $konsultasihukum['id_konsultasihukum']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_konsultasihukum" value="<?= $konsultasihukum['slug_konsultasihukum']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_konsultasihukum')) ? 'is-invalid' : ''; ?>" id="judul_konsultasihukum" name="judul_konsultasihukum" autofocus value="<?= (old('judul_konsultasihukum')) ? old('judul_konsultasihukum') : $konsultasihukum['judul_konsultasihukum'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_konsultasihukum')) ? old('isi_konsultasihukum') : $konsultasihukum['isi_konsultasihukum'] ?>
                        </textarea>
