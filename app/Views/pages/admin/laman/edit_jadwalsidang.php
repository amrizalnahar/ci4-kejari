...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/jadwalsidang/update/<?= $jadwalsidang['id_jadwalsidang']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_jadwalsidang" value="<?= $jadwalsidang['slug_jadwalsidang']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_jadwalsidang')) ? 'is-invalid' : ''; ?>" id="judul_jadwalsidang" name="judul_jadwalsidang" autofocus value="<?= (old('judul_jadwalsidang')) ? old('judul_jadwalsidang') : $jadwalsidang['judul_jadwalsidang'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_jadwalsidang')) ? old('isi_jadwalsidang') : $jadwalsidang['isi_jadwalsidang'] ?>
                        </textarea>
