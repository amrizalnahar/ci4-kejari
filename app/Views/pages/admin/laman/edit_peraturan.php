...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/peraturan/update/<?= $peraturan['id_peraturan']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="slug_peraturan" value="<?= $peraturan['slug_peraturan']; ?>">

                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_peraturan')) ? 'is-invalid' : ''; ?>" id="judul_peraturan" name="judul_peraturan" autofocus value="<?= (old('judul_peraturan')) ? old('judul_peraturan') : $peraturan['judul_peraturan'] ?>" placeholder="Masukkan Judul">
                        ...
                        <?= (old('isi_peraturan')) ? old('isi_peraturan') : $peraturan['isi_peraturan'] ?>
                        </textarea>
