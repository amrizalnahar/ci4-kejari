...
<div class="content">
    ...
    <section class="content container-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="/admin/datatilang/save" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('judul_datatilang')) ? 'is-invalid' : ''; ?>" id="judul_datatilang" name="judul_datatilang" autofocus value="<?= old('judul_datatilang'); ?>" placeholder="Masukkan Judul">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <label class="input-group-text myPreviewgambar" for="gambar_datatilang">Pilih Gambar</label>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="tag_datatilang" id="tag_datatilang" class="form-control" placeholder="Masukkan Tag ..." value="<?= old('tag_datatilang'); ?>">
                        </div>
