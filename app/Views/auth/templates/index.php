...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?= base_url(); ?>/plugins/admin/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<body class="hold-transition login-page">
    ...
    <!-- jQuery -->
    <script src="<?= base_url(); ?>/plugins/admin/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap 4 -->
